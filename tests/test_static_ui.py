...
def test_service_worker_forces_static_shell_refresh() -> None:
    ...
    assert 'href="/styles.css?v=63"' in html
    assert 'src="/app.js?v=63"' in html
    assert 'const CACHE_NAME = "repeaterwatch-static-v63";' in sw
    assert '"/styles.css?v=63"' in sw
    assert '"/app.js?v=63"' in sw
