...
function formatApiReason(value) {
  const labels = {
    ...
    remote_transcription_quota_exceeded: "Transcription quota exceeded",
    short_recording: "Short recording guardrail",
    remote_summary: "Remote summary",
    remote_summary_rate_limited: "Summary rate-limited",
    remote_summary_quota_exceeded: "Summary quota exceeded",
    remote_activity_chat: "Remote activity chat",
    remote_activity_chat_rate_limited: "Activity chat rate-limited",
    remote_activity_chat_quota_exceeded: "Activity chat quota exceeded",
